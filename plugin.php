...
// TODO: change 'NitroSMS' to the name of your actual plugin
class NitroSMS extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			'widget-name-id',
			__( 'NitroSMS Cancel', 'widget-name-locale' ),
			array(
	...
	public function widget( $args, $instance ) {
    	...
    	$title = apply_filters('widget_title', empty( $instance['title'] ) ? __( 'NitroSMS', 'widget-name-locale' ) : $instance['title'], $instance, $this->id_base);
	...
	public function register_widget_scripts() {
		...
		// TODO change 'widget-name' to the name of your plugin
		wp_register_script( 'nitrosmsscripts', plugins_url( 'smscancel/js/widget.js' ) );
		wp_enqueue_script('jquery');
		wp_enqueue_script( 'nitrosmsscripts' );
